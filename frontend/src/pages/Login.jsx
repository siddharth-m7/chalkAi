    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-sm p-8 sm:p-10">
        ...
        <div className="text-center mb-8">
          <h1 className="font-serif text-3xl font-bold text-charcoal mb-2">Welcome Back</h1>
          <p className="text-sm text-gray-500">Sign in to continue generating AI-powered content.</p>
        </div>
        ...
        {/* Demo account card */}
        <div className="flex items-center justify-between bg-gray-50 border border-gray-200 rounded-2xl px-4 py-3 mb-6">
          <div>
            <p className="text-sm font-semibold text-charcoal mb-0.5">Demo account</p>
            <p className="text-xs text-gray-500">Email: demo@chalkai.com</p>
            <p className="text-xs text-gray-500">Password: demo123456</p>
          </div>
          <button
            onClick={handleDemo}
            disabled={loading}
            className="px-4 py-2 text-sm font-medium border border-gray-200 bg-white rounded-xl hover:bg-gray-50 text-charcoal disabled:opacity-50 transition-colors shrink-0"
          >
            Use Demo
          </button>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-gray-500">
          ...
          <Link to="/register" className="font-bold text-charcoal hover:text-terracotta transition-colors">
            Create Account
          </Link>
        </p>
      </div>
